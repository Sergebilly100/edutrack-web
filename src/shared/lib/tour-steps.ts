...
export const validationsTourSteps: Step[] = [
  ...
  },
  {
    ...
    content: "Cet onglet recense les professeurs qui n'ont pas scanné la fin de leur cours. Sans scan de fin, le système ne peut pas confirmer l'heure réelle de sortie. Vous pouvez sanctionner, ignorer ou excuser chaque cas.",
    placement: "bottom",
  },
  {
...
export const teachersTourSteps: Step[] = [
  {
    ...
    content: "C'est l'onglet par défaut. Il affiche tous vos professeurs dans un tableau. Vous pouvez chercher, filtrer et cliquer sur une ligne pour ouvrir le profil complet du prof.",
    placement: "bottom",
    skipBeacon: true,
  },
  {
    ...
    content: "Cet onglet vous donne des statistiques détaillées sur la présence de chaque professeur sur une période que vous choisissez : taux de présence, absences, retards. Pratique pour repérer les profs peu assidus.",
    placement: "bottom",
  },
  {
    target: "[data-tour='teachers-tab-classement']",
    title: "Onglet Classement",
    content: "Ce classement mensuel donne un score de conformité à chaque prof : il tient compte des présences, des retards, des scans de fin et des validations en attente. Plus le score est bas, plus le prof mérite votre attention.",
    placement: "bottom",
  },
  {
  ...
  },
  {
    ...
    content: "'Ajouter un prof' ouvre le formulaire de création. 'Envoyer les identifiants' envoie par email un mot de passe temporaire à tous les profs qui n'ont jamais reçu leurs accès à l'application de pointage.",
    placement: "left",
  },
]
...
export const teacherDetailTourSteps: Step[] = [
  {
    ...
    content: "Ce bloc affiche pour le mois actuel : les heures prévues à l'EDT, les heures effectivement pointées, les heures d'absence et le statut du salaire (en attente, payé…). C'est une vue rapide avant d'aller dans le détail.",
    placement: "bottom",
    skipBeacon: true,
  },
  {
  ...
  },
  {
    ...
    content: "Ce bloc affiche les créneaux de cours de ce professeur pour la semaine en cours et le lendemain. Cliquez sur 'Voir EDT semaine complète' pour afficher tous les jours. Si aucun créneau n'apparaît, le prof n'a pas été affecté à des cours dans l'EDT.",
    placement: "top",
  },
  {
    target: "[data-tour='teacher-detail-tab-presences']",
    title: "Onglet Présences",
    content: "Cet onglet contient l'historique complet des séances du professeur : date, créneau, matière, statut (présent/absent/retard), heure d'entrée/sortie, salle et pointage des élèves. Changez le mois avec le menu en haut. Le calendrier thermique donne une vue mensuelle d'un coup d'œil.",
    placement: "bottom",
  },
  {
  ...
  },
  {
    ...
    title: "Onglet Infos",
    content: "Cet onglet permet de modifier les coordonnées du prof (email, téléphone, matières, taux horaire). C'est aussi ici que vous pouvez réinitialiser son mot de passe : un nouveau mot de passe temporaire est généré et envoyé par email. Le prof devra le changer à sa prochaine connexion.",
    placement: "bottom",
  },
]
...
export const studentsTourSteps: Step[] = [
  {
    ...
    title: "Onglet Liste — vue principale",
    content: "Liste complète de tous vos élèves. La colonne 'Abs. mois' affiche le nombre d'absences ce mois-ci. Les élèves avec trop d'absences apparaissent en rouge — cliquez sur leur ligne pour ouvrir leur fiche.",
    placement: "bottom",
    skipBeacon: true,
  },
  {
  ...
  },
  {
    ...
    content: "Ce bouton ouvre le formulaire de création d'un élève : vous renseignez la classe, le nom, le prénom, le matricule et les numéros de téléphone des parents. Le téléphone parent est nécessaire pour recevoir les alertes SMS d'absence.",
    placement: "left",
  },
]
...
export const studentDetailTourSteps: Step[] = [
  ...
  },
  {
    ...
    content: "Cet onglet contient les contacts des parents : nom, téléphone et email. Ces coordonnées sont utilisées pour les alertes SMS d'absence. Modifiez-les ici si le numéro change.",
    placement: "bottom",
  },
  {
...
export const scheduleTourSteps: Step[] = [
  ...
  },
  {
    ...
    content: "Pour modifier ou supprimer un créneau existant dans la grille, cliquez directement dessus.",
    placement: "center",
  },
]
...
export const salariesTourSteps: Step[] = [
  ...
  },
  {
    ...
    content: "Appuyez ici pour lancer le calcul du mois sélectionné. Le système lit toutes les présences validées et génère les fiches de paie. À relancer chaque fois qu'une présence est modifiée ou validée pour que les montants soient à jour.",
    placement: "bottom",
  },
  {
  ...
  },
  {
    ...
    content: "Ces cartes résument la situation financière du mois : montant total à payer aux vacataires, montant total à payer aux permanents, nombre de fiches en attente de paiement. Elles se mettent à jour après chaque calcul.",
    placement: "bottom",
  },
  {
...
export const subscriptionsTourSteps: Step[] = [
  ...
  },
  {
    ...
    content: "Chaque ligne correspond à un parent. Le badge de couleur indique l'état : vert = actif, orange = expire bientôt, rouge = expiré. Le bouton 'Voir dossier' ouvre la fiche complète. Le menu ⋮ permet de renouveler, modifier le téléphone ou annuler.",
    placement: "top",
  },
  {
    target: "[data-tour='subscriptions-add-btn']",
    title: "Créer un nouvel abonnement",
    content: "Ce bouton ouvre le formulaire de création : saisissez le nom et le téléphone du parent, choisissez la durée et le montant. Le parent reçoit ses identifiants par SMS pour accéder au portail de suivi des absences.",
    placement: "left",
  },
]
...
export const subscriptionRevenueTourSteps: Step[] = [
  ...
  },
  {
    ...
    content: "IvoirEdu prélève un pourcentage sur chaque abonnement collecté. Ce bloc indique le montant dû ce mois-ci. Si un versement est en attente, une alerte orange apparaît — contactez IvoirEdu pour régulariser avant la date limite.",
    placement: "bottom",
  },
  {
  ...
  },
  {
    ...
    content: "Cet onglet enregistre tous les versements effectués à IvoirEdu pour ce mois. Après chaque versement de commission, ajoutez-le ici pour garder une trace comptable et sortir l'alerte en attente.",
    placement: "top",
  },
]
...
export const roomsTourSteps: Step[] = [
  ...
  },
  {
    ...
    content: "Ce bouton ouvre le formulaire de création : renseignez le nom de la salle, le bâtiment (facultatif), la capacité et les coordonnées GPS si vous activez la vérification de géolocalisation. Le rayon GPS définit la distance maximale tolérée pour un pointage valide.",
    placement: "left",
  },
  {
    target: "[data-tour='rooms-table']",
    title: "Liste des salles et QR Codes",
    content: "Le tableau affiche toutes vos salles. Chaque ligne propose : 'Voir QR' pour afficher et imprimer le code QR de la salle, 'Modifier' pour changer les infos, et 'Supprimer' (désactivé si la salle est utilisée dans des créneaux). Imprimez et affichez les QR codes dans les salles pour que les profs puissent les scanner.",
    placement: "top",
  },
]
...
export const importTourSteps: Step[] = [
  ...
  {
    target: "[data-tour='import-wizard']",
    title: "Étape 1 — Choisir le type et télécharger le modèle",
    content: "Commencez par sélectionner ce que vous voulez importer (élèves, professeurs ou EDT). Téléchargez ensuite le fichier modèle Excel (.xlsx) fourni et remplissez-le avec vos données. Respectez exactement les colonnes du modèle — une colonne manquante ou renommée bloque l'import.",
    placement: "top",
  },
  {
    target: "[data-tour='import-wizard']",
    title: "Étape 2 — Mode fusion ou remplacement",
    content: "Avant d'uploader le fichier, choisissez le mode d'import :\n• Fusion : ajoute les nouvelles données sans toucher aux existantes (recommandé pour les mises à jour).\n• Remplacement : efface TOUTES les données du type sélectionné et les remplace par le fichier. À utiliser uniquement si vous refaites une saisie complète.",
    placement: "top",
  },
  {
    target: "[data-tour='import-wizard']",
    title: "Étape 3 — Validation avant confirmation",
  ...
  {
    target: "[data-tour='import-wizard']",
    title: "Import EDT — période de validité",
    content: "Pour l'import de l'emploi du temps, vous devez spécifier une période de validité (ex : Trimestre 1, Semestre 2…). Cette période détermine quand les créneaux sont actifs. Si vous importez un nouvel EDT pour remplacer l'actuel, créez d'abord une nouvelle période dans Paramètres → Périodes.",
    placement: "top",
  },
  {
